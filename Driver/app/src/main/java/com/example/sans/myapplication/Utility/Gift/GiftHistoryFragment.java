...
import com.example.sans.myapplication.Utility.Gift.GiftHistoryAdapter;
...
public class GiftHistoryFragment extends Fragment {
    ...
    public static GiftHistoryFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        client.post("gifts/getMyRedeemRecords", params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    JSONArray order_array = response.getJSONObject("data").getJSONArray("redeem_records");
                    ...
                    Toast.makeText(GiftHistoryFragment.this.getActivity(), "" + e, Toast.LENGTH_SHORT).show();
                }
                mAdapter.notifyDataSetChanged();
                mAdapter = new GiftHistoryAdapter(items);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable error, JSONObject response) {
                Toast.makeText(GiftHistoryFragment.this.getActivity(), "" + statusCode + " " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        ...
        final View view = inflater.inflate(R.layout.fragment_gift_history , container, false);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.gift_history_recycler_view);
